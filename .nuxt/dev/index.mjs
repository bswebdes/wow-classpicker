...
import { stringify, uneval } from 'file://C:/Webdev/classpicker/node_modules/devalue/index.js';
import { isVNode, isRef, toValue } from 'file://C:/Webdev/classpicker/node_modules/vue/index.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file://C:/Webdev/classpicker/node_modules/unhead/dist/plugins.mjs';
import { createHooks } from 'file://C:/Webdev/classpicker/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://C:/Webdev/classpicker/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://C:/Webdev/classpicker/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Webdev/classpicker/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Webdev/classpicker/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file://C:/Webdev/classpicker/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Webdev/classpicker/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://C:/Webdev/classpicker/node_modules/consola/dist/index.mjs';
...
import { dirname as dirname$1, resolve as resolve$1 } from 'file://C:/Webdev/classpicker/node_modules/pathe/dist/index.mjs';
import { walkResolver } from 'file://C:/Webdev/classpicker/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"C:/Webdev/classpicker/server/assets"}];
...
const _HoFpK9zgbmA_XoqzOlBzcDeCMeg99beu9ZTNe1h9Kc = (function(nitro) {
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"Welche Klasse sollst du in WoW: Midnight spielen? Lass den WoW Class Picker entscheiden! Der ultimative Zufallsgenerator für World of Warcraft."},{"name":"format-detection","content":"telephone=no"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"},{"rel":"preconnect","href":"https://fonts.googleapis.com"},{"rel":"preconnect","href":"https://fonts.gstatic.com","crossorigin":""},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Permanent+Marker&family=Press+Start+2P&display=swap"}],"style":[],"script":[],"noscript":[],"title":"WoW Midnight Class Picker - Dein Klassen-Zufallsgenerator","htmlAttrs":{"lang":"de"}};
...
const _neT_YrzXHMlVARK4oQHmKg2aWdM4jRRvOXo94UF9jUY = (nitroApp) => {
...
const getServerEntry = () => import('file://C:/Webdev/classpicker/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
// @ts-expect-error file will be produced after app build
const getClientManifest = () => import('file://C:/Webdev/classpicker/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
// -- SSR Renderer --
